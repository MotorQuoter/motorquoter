...
removalMode: how the FRONT bumper was removed — set only when apertureExposed is true. "peel" = bumper torn or dragged off in tension (pulled rearward or outward off its mounts, mount tabs failed in tension, fasteners stripped, NO perpendicular inward crush of the adjacent body, exposed seam clean — travelling-forward snag against a kerb or obstruction is the canonical case). "crush" = bumper driven inward by perpendicular impact, adjacent body panel shows crush, intrusion, or folding, force transmitted into the structure behind. "indeterminate" = cannot confidently distinguish from the photos. Judge mode from the bumper's own removal evidence — NOT from whether the adjacent wing or panel looks damaged. Silent tool parameter; do not write it in the report.
rearRemovalMode: same as removalMode but for the REAR bumper — set only when rearApertureExposed is true. "peel" = rear bumper torn or dragged off in tension, mount tabs failed, NO perpendicular inward crush into the rear body, exposed seam clean. "crush" = rear bumper driven inward by perpendicular impact, rear body or quarter panel shows crush or intrusion. "indeterminate" = cannot confidently distinguish. Silent tool parameter; do not write it in the report.
