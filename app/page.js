      ...
      <div className="app">
        ...
        >
          ...
          <div style={{ fontSize: 13, color: 'var(--text)', lineHeight: 1.55 }}>
            ...
            Work out the VRT with <a href="https://www.ros.ie/evrt-enquiry/vrtenquiry.html" target="_blank" rel="noopener noreferrer" style={{ color: 'var(--orange)', fontWeight: 600, textDecoration: 'none' }}>Revenue&rsquo;s official VRT calculator</a> — the free, official tool (opens in a new tab).
          </div>
        </div>
