...
export const LABOUR_RANGE_ADDENDUM = 'Labour & paint is an estimate, shown as a range. The repair total, margins and bid ceilings all use the top of that range. If your repairer quotes less, remove the line and add their figure.';
