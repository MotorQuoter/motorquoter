...
export const PANEL = Object.freeze({
  ...
  // batch 158 B1 — LIVE again (Vincent, 18 Sep: "I need it fixed"). The batch 157 freeze is lifted for
  // these: both vocabulary lines and the TRIM BEFORE PANEL rule are back in the prompt, so the model can
  // name them and the engine can cost them. The cassettes are invalidated by that and no re-record was
  // approved — the 16-lot replay cannot run at £0 past this commit, which is expected, not a fault.
