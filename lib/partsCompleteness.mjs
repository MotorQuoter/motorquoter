...
function fogRuleForEnd(fogParts, bumperGone, endLabel, fogSeed, bumperConfirmed = false) {
  ...
  if (bumperGone && n < 2 && !bumperConfirmed) {
    ...
    flags.push({
      panelId: PANEL.FOG_LAMP, partName: `${endLabel} fog lamp(s)`, zone: endLabel, weight: 'low',
      reason: `The ${endLabel} bumper was read as displaced but its condition could not be confirmed across the photos. If it is genuinely off, both ${endLabel} fog lamps sit in it — surfaced for inspection, NOT costed. Confirm on the WhatsApp inspection and price it yourself if it applies.`,
