...
export const PANEL_PRICE_TABLE = Object.freeze({
  ...
  // Keyed SRS_AIRBAG_T1/T2/T3 and looked up by the assess route's SRS_PSEUDO_PANEL sentinel —
  // these are never read by the vision pass and never appear in the panel vocabulary.
