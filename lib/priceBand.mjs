...
export const PANEL_PRICE_TABLE = Object.freeze({
  ...
  // used = S/H kit fitted figure used in repair total; oem = new figure carried for future use.
  // SRS fitting labour is absorbed in the Labour & paint aggregate — no labour rider on the row.
  SRS_AIRBAG_T1: {
