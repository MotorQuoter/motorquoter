...
function pickPlate(entry) {
  ...
  for (const k of ['registration_mark', 'vehicle_registration_mark', 'registration', 'vrm', 'plate', 'number_plate', 'previous_vrm', 'previous_registration']) {
    const v = entry[k];
...
function pickPlateDate(entry) {
  ...
  for (const k of ['date_of_change', 'date_of_last_change', 'change_date', 'date', 'date_of_transaction', 'transaction_date']) {
