...
// The single gate on spending money. Refund on a genuine empty result and on nothing else — a
// provider error or an unanswered poll leaves the customer with their report (service history
// marked unavailable) and raises an alert. A refund may still be the right commercial call there,
// but it must be a decision someone made, not an accident of null-handling.
